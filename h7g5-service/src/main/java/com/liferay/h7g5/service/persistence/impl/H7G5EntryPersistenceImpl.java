	...
	public H7G5Entry updateImpl(H7G5Entry h7g5Entry) {
		...
		if (isNew && (h7g5Entry.getCreateDate() == null)) {
			if (serviceContext == null) {
				h7g5Entry.setCreateDate(now);
			}
			else {
				h7g5Entry.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!h7g5EntryModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				h7g5Entry.setModifiedDate(now);
			}
			else {
				h7g5Entry.setModifiedDate(serviceContext.getModifiedDate(now));
			}
		}
