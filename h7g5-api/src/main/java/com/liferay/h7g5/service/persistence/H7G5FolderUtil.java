...
public class H7G5FolderUtil {
	...
	private static ServiceTracker<H7G5FolderPersistence, H7G5FolderPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(H7G5FolderPersistence.class);

		ServiceTracker<H7G5FolderPersistence, H7G5FolderPersistence>
			serviceTracker =
				new ServiceTracker
					<H7G5FolderPersistence, H7G5FolderPersistence>(
						bundle.getBundleContext(), H7G5FolderPersistence.class,
						null);
