	...
	public H7G5Folder updateImpl(H7G5Folder h7g5Folder) {
		...
		if (isNew && (h7g5Folder.getCreateDate() == null)) {
			if (serviceContext == null) {
				h7g5Folder.setCreateDate(now);
			}
			else {
				h7g5Folder.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!h7g5FolderModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				h7g5Folder.setModifiedDate(now);
			}
			else {
				h7g5Folder.setModifiedDate(serviceContext.getModifiedDate(now));
			}
		}
