...
public class H7G5EntryUtil {
	...
	private static ServiceTracker<H7G5EntryPersistence, H7G5EntryPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(H7G5EntryPersistence.class);

		ServiceTracker<H7G5EntryPersistence, H7G5EntryPersistence>
			serviceTracker =
				new ServiceTracker<H7G5EntryPersistence, H7G5EntryPersistence>(
					bundle.getBundleContext(), H7G5EntryPersistence.class,
					null);
